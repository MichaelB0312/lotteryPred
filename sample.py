...
vae = Vae(x_dim=args.x_dim, z_dim=args.z_dim, hidden_size=args.hidden_size, device=device, num_layers=args.trans_layers, extraDecFC_dim=args.extra_dec_dim, isExtraLayer=True).to(device)
